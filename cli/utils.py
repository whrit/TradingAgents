...
def select_shallow_thinking_agent(provider) -> str:
    ...
    SHALLOW_AGENT_OPTIONS = {
        "openai": [
            ("GPT-5.1 - Flagship reasoning model (balanced speed/cost)", "gpt-5.1"),
            ("GPT-5-mini - Fast default for most workflows", "gpt-5-mini"),
            ("GPT-5-nano - Lowest latency, lowest cost", "gpt-5-nano"),
        ],
        "anthropic": [
