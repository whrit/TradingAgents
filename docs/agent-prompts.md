# Trading Agents - Agent Names and Prompts

This document contains all agent names and their associated prompts from the TradingAgents system.
...
### News Analyst
tradingagents/agents/analysts/news_analyst.py:18-21
...
tradingagents/agents/analysts/social_media_analyst.py:18-21
...
### Market Analyst
tradingagents/agents/analysts/market_analyst.py:20-47
...
tradingagents/agents/analysts/fundamentals_analyst.py:21-25
...
### Macro Economist
tradingagents/agents/analysts/macro_economist.py:13-22

You are a Macro Economist tasked with synthesizing policy updates, inflation prints, yield-curve shifts, and global risk sentiment. Use the available tools to gather CPI/PPI coverage, central-bank commentary, and geopolitical developments. Provide:
...
tradingagents/agents/analysts/alternative_data_analyst.py:14-22

You specialize in alternative data: satellite imagery, credit-card spend trackers, web traffic, supply-chain telemetry, and app-download trends. Use the tools to collect the snapshot and cross-check it with any relevant headlines. Discuss:
...
### Research Manager
tradingagents/agents/managers/research_manager.py:22-39
...
### Risk Manager
tradingagents/agents/managers/risk_manager.py:25-44
...
tradingagents/agents/managers/execution_strategist.py:38-44

You are an execution strategist. Using the context below, craft a routing plan describing order slicing, venue preference, and slippage expectations. If instruction is None, explain why no trade should be routed.
...
### Compliance Officer
tradingagents/agents/managers/compliance_officer.py:29-36
...
### Bear Researcher
tradingagents/agents/researchers/bear_researcher.py:25-45
...
### Bull Researcher
tradingagents/agents/researchers/bull_researcher.py:25-43
...
tradingagents/agents/risk_mgmt/aggresive_debator.py:21-34
...
### Neutral Debator
tradingagents/agents/risk_mgmt/neutral_debator.py:21-34
...
tradingagents/agents/risk_mgmt/conservative_debator.py:22-35
...
### Risk Quant
tradingagents/agents/risk_mgmt/risk_quant.py:15-21

You are a quantitative risk analyst producing VaR/ES guidance and hedge ideas. Always call the risk tool to pull the latest metrics, then translate them into actionable guardrails: target gross exposure, hedge ratios, and stop levels. Summaries must include a short bullet list covering VaR, tail risk, hedge idea, and recommended risk capital usage.
...
### Trader
tradingagents/agents/trader/trader.py:32-34
