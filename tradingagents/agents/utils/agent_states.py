...
class AgentState(MessagesState):
    ...
    macro_report: Annotated[str, "Macro economist top-down view"]
    alternative_data_report: Annotated[str, "Alternative data snapshot"]
    ...
    risk_quant_report: Annotated[str, "Quantitative risk summary"]
    risk_metrics_json: Annotated[str, "Serialized JSON metrics from risk engine"]
    execution_plan: Annotated[str, "Execution strategy"]
